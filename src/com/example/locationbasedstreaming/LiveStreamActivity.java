...
public class LiveStreamActivity extends Activity implements OnClickListener {
	...
	private String ffmpeg_link = "rtmp://server here/app name";
	private String stream_name = "locationbasedstream";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        if (i.hasExtra(MainActivity.UNIQUE_ID)) {
        	stream_name = i.getStringExtra(MainActivity.UNIQUE_ID);
        	//stream_name = "START" + stream_name + "END";
        }
