...
public class TwitterAuthenticationToken {
	...
	public TwitterAuthenticationToken(String id, String token, String secret) {
		this.id = id;
		this.token = token;
		this.secret = secret;
	}
	
	public TwitterAuthenticationToken(final Cursor cursor) {
