package com.watamidoing.contentproviders;
...
public class TwitterAuthenticationProvider extends ContentProvider {
    ...
    public static final String AUTHENTICATION = SCHEME + AUTHORITY + "/twitter";
	...
	public Cursor query(Uri uri, String[] projection, String selection,
        ...
        if (URI_AUTHENTICATION.equals(uri)) {
            result = DatabaseHandler
                    ...
                    .getReadableDatabase()
                    .query(TwitterAuthenticationToken.TABLE_NAME, TwitterAuthenticationToken.FIELDS, null, null, null,
                            null, null, null);
            ...
            result = DatabaseHandler
                    .getInstance(getContext())
                    .getReadableDatabase()
                    .query(TwitterAuthenticationToken.TABLE_NAME, TwitterAuthenticationToken.FIELDS,
