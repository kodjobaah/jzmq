...
public class ChatDialogFragment extends DialogFragment {
	...
	private LinkedList<Participant> pendingParticipantsMessages;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		chatLayoutView = inflater.inflate(R.layout.chat_layout, container,
				false);
		...
		participantsView = (ListView) chatLayoutView
				.findViewById(R.id.chatParticipants);
		...
		sendMessage.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (message.length() > 0) {
					...
					UtilsWhatAmIdoing.displayGenericToast(context,
							"Enter Some Text");
				}
		...
		chatLayoutView.post(new Runnable() {
			...
			public void run() {
				...
				RelativeLayout sendChatLayout = (RelativeLayout) chatLayoutView
						.findViewById(R.id.sendChatLayout);
	...
	public void onStart() {
		...
		if (pendingParticipantsMessages != null) {
			Participant oldParticipant = pendingParticipantsMessages.poll();
			while (oldParticipant != null) {
				addParticipant(oldParticipant);
				oldParticipant = pendingParticipantsMessages.poll();
			}
		}
	}
	...
	public void onResume() {
		...
		*/
		// chatMessage.setLayoutParams(new
		// RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.FILL_PARENT,(int)
		// (height)));
	...
	public void onPause() {
		...
		// int height = sendMessage.getHeight();
		// chatMessage.setLayoutParams(new
		// RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT,(int)
		// (height)));
	...
	public void addParticipant(Participant participant) {
		...
		if (pma == null) {
			...
			ArrayList<String> values = new ArrayList<String>(
					Arrays.asList(oldValues));
			if (participant.getType().equalsIgnoreCase(
