...
public class WhosWatchingAdapter extends BaseAdapter {
	...
	public WhosWatchingAdapter(Activity activity, List<User> users) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View vi=convertView;
        if(convertView==null)
            vi = inflater.inflate(R.layout.whoes_watching_row, null);
		// TODO Auto-generated method stub
